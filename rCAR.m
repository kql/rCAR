...
%
function [ data_out ref_est nn_ref_est ] = robustCARf( data_in, dt, n_min_contributing_channels, n_cores, pool )
...
[ re_fdata_out re_ref_est nn_re_ref_est ]     = robustCAR5_winsz( re_fdata, dt, n_min_contributing_channels, pool );
[ im_fdata_out im_ref_est nn_im_ref_est ]     = robustCAR5_winsz( im_fdata, dt, n_min_contributing_channels, pool );
...
% data_out                  = data_out'; 
 data_out                  = data_out; % avoid transposing data
